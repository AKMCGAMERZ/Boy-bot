...
# ================= HELP COMMAND =================
@client.tree.command(name="help", description="Show bot help")
async def help_command(interaction: discord.Interaction):
    text = (
        ...
        "🐧 Ubuntu - Stable and widely-used Linux distribution\n"
        "🦕 Debian - Rock-solid stability with large software repository\n"
        "⛰️ Alpine - Lightweight and security-focused\n"
        "🎯 Arch - Rolling release with bleeding-edge software\n"
        "💣 Kali - Penetration testing and security auditing\n"
        "🎩 Fedora - Innovative features with Red Hat backing"
    )
    ...
    embed.set_footer(
        text="💜 Need help? Contact staff!",
        icon_url="https://cdn.discordapp.com/attachments/1420773115629146204/1420779546906722435/Picsart_25-09-22_20-21-35-664.jpg"
    )
